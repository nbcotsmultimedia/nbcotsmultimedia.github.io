    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      function applySimpleFadeStyle(ctx, size, logo) {
        ...
        gradient.addColorStop(0, 'rgba(51,51,204,0)');     // Transparent at top of fade area
        gradient.addColorStop(0.3, 'rgba(51,51,204,0.25)');  // Slight fade
        gradient.addColorStop(1, 'rgba(51,51,204,0.9)');    // Opaque black at bottom
