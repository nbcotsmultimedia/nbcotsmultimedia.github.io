...
function init() {
	...
	sheets[0] = "https://docs.google.com/spreadsheets/d/e/2PACX-1vT_w5rpdLuRBeUgsMFSUBIaPgPqyhjjEMe1Mj6zLVnuLxirKTmBVze8oDZlN70SRXr7F1rpAMleC8zU/pub?gid=1278127126&single=true&output=csv";
	...
	if (myparent == undefined || myparent == null || myparent == "" || myparent == "https://ots.nbcwpshield.com/" || myparent == "http" ) {
		myparent = "https://www.telemundo51.com/";
	}
...
function generateGrid() {
	...
	for (var i=0; i<totalEntries; i++) {
		...
		$("#gridCon").append("<div class='item' id='th" + i + "' data-id='" + i + "' data-gid='" + (i+1) + "'>" +
												...
												"<p class='pRole'>" + allData[i].bio + " murió el " + allData[i].died + " a la edad de " + allData[i].age + ".&nbsp; <a href='" + myparent + allData[i].link + "' target='_blank'>Más aquí</a></p>" +
												"</div>");
		//CLICK FUNCTION
		$("#th" + i).click(function () {
