      ...
      async function generatePreviews() {
        ...
        try {
          ...
          function addMedalist() {
            ...
            const dataToSend = { ...headlineSoFar};
            dataToSend["event"] = eventInput.value;
          ...
          const downloadAllCards = () => {
            try {
              ...
              alert('You may need to allow this website to download multiple files in your browser settings.');
            }
